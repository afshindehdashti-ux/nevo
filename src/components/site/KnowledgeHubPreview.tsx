...
import { getKnowledgeHubPreview, type SolutionsRouteKey } from "@/lib/knowledge-hub-preview-config";
...
export function KnowledgeHubPreview({
  ...
  const resolvedTitle = title ?? config?.title ?? "Read the engineering behind this scope.";
  const resolvedLede =
    lede ??
    config?.lede ??
  ...
  const articleUrl = (slug: string) => `${SITE.url}${localePrefix}/knowledge-hub/${slug}`;
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="max-w-xl">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  We are curating the library for this solution. Explore the full Knowledge Hub or
                  download technical references in the Download Center.
                </p>
              </div>
            </div>
