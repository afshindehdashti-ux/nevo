...
export const ARTICLES: Article[] = [
  {
    ...
    cover: k17, category: "PIR", section: "Technical Articles", readMin: 14,
    level: "Professional", featured: true, popular: true, date: "2026-05-18", author: AUTHOR,
    key_takeaways: [
    ...
    body: [
      { h: "Why the comparison matters", p: [
  ...
  },
  {
    ...
    cover: k28, category: "Thermal", section: "Engineering Guides", readMin: 11,
    level: "Professional", featured: true, date: "2026-05-02", author: AUTHOR,
    key_takeaways: [
    ...
    body: [
      { h: "Step 1 — Establish the target U-value", p: [
      ...
      { h: "Worked example — cold storage in Dubai", p: [
  ...
  },
  {
    ...
    excerpt: "How a continuous PIR line works: coil, roll-forming, chemical mixing, laminator, saw.",
    cover: k07, category: "Production Lines", section: "Production Technology", readMin: 12,
    level: "Beginner", featured: true, popular: true, date: "2026-04-10", author: AUTHOR,
    key_takeaways: [
    ...
    body: [
      ...
      { h: "Roll-forming and edge treatment", p: [
      ...
      { h: "Chemical mixing and foam deposition", p: [
      ...
      { h: "Cutting, stacking and packing", p: [
  ...
  },
  {
    ...
    cover: k21, category: "Cold Rooms", section: "Industry Applications", readMin: 10,
    level: "Professional", date: "2026-04-22", popular: true, author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k23, category: "Clean Rooms", section: "Industry Applications", readMin: 9,
    level: "Professional", date: "2026-03-30", author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k28, category: "Fire", section: "Design Standards", readMin: 8,
    level: "Beginner", date: "2026-03-11", author: AUTHOR,
    key_takeaways: [
    ...
    body: [
      ...
      { h: "EN 13501-2 fire-resistance", p: [
  ...
  },
  {
    ...
    cover: k33, category: "Factory Design", section: "Factory Development", readMin: 15,
    level: "Expert", featured: true, date: "2026-02-28", author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k36, category: "Project Management", section: "Factory Development", readMin: 18,
    level: "Expert", popular: true, date: "2026-02-15", author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k14, category: "Chemicals", section: "Raw Materials", readMin: 11,
    level: "Expert", date: "2026-01-22", author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k16, category: "Rock Wool", section: "Raw Materials", readMin: 9,
    level: "Professional", date: "2026-01-14", author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k26, category: "Thermal", section: "Industry Applications", readMin: 8,
    level: "Beginner", date: "2025-12-19", author: AUTHOR,
    key_takeaways: [
  ...
  },
  {
    ...
    cover: k01, category: "Quality", section: "Installation Guides", readMin: 12,
    level: "Professional", date: "2025-12-04", author: AUTHOR,
    key_takeaways: [
