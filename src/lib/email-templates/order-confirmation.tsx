...
const OrderConfirmationEmail = ({
  ...
  return (
    <Html lang="en" dir="ltr">
      <EmailHead />
      <Preview>{orderNumber ? `Order ${orderNumber} received` : "We received your order"}</Preview>
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.card} className="card">
            ...
            <Text style={styles.text} className="text">
              {greeting} thank you for your order. Our team has recorded your request and will be in
              touch shortly with next steps and production timeline.
            </Text>
