        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.card} className="card">
            <Heading style={styles.h1} className="h1">
              Thanks — your project inquiry is in
            </Heading>
            <Text style={styles.text} className="text">
              {greeting}
            </Text>
            <Text style={styles.text} className="text">
              We&apos;ve received your inquiry and routed it to the right specialist. You can expect
              a personal reply from our engineering or sales team within one business day.
            </Text>
            ...
            <Text style={styles.small} className="small">
              ...
              and quote your reference above.
            </Text>
          </Section>
