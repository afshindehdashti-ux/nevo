        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.card} className="card">
            ...
            <Text style={styles.text} className="text">
              A new inquiry just landed from the website. Please review and route to the right owner
            ...
            <Section style={{ margin: "0 0 20px" }}>
              ...
              {email ? (
                <Text style={rowStyle}>
                  ...
                  <Link href={`mailto:${email}`} style={styles.link} className="link">
                    {email}
                  </Link>
                </Text>
              ) : null}
              ...
              {sourcePage ? (
                <Text style={rowStyle}>
                  <span style={labelStyle}>Source page:</span>
                  {sourcePage}
                </Text>
              ) : null}
              {submittedLabel ? (
