    ...
    <Section id="industries" className="bg-secondary/40">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {items.map((ind, i) => {
          ...
          return (
            <motion.article key={ind.t} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ delay: (i % 3) * 0.08, duration: 0.6 }} className="group overflow-hidden rounded-lg border border-border bg-white transition-shadow hover:shadow-lg">
