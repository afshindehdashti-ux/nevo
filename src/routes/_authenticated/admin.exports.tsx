            ...
            return (
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <div className="rounded-md border bg-muted/40 p-2 text-xs space-y-2">
                    <div>
                      ...
                      <div className="font-mono break-all">{expected}</div>
                    </div>
                    <div>
                      <div className="text-[11px] uppercase tracking-wide text-muted-foreground">
                        Computed (from selected file's payload)
                      </div>
                      <div className={`font-mono break-all ${isMismatch ? "text-destructive" : ""}`}>
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <Button size="sm" onClick={() => setBlocked(null)}>Close</Button>
                </div>
              </div>
            );
          })()}
