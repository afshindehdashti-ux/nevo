...
const PRODUCTS = [
  ...
  {
    title: "Sandwich Panels — PIR / RW / PU / EPS",
    cat: "Finished Panels",
    img: A[13],
    stat: "3,250 m² this month",
  },
  {
    title: "Raw Materials — Steel Coils & Chemicals",
    cat: "Raw Materials",
    img: A[16],
    stat: "42 SKUs",
  },
...
const AI_TOOLS = [
  {
    ...
    desc: "Draft a branded partner proposal from a lead brief.",
    icon: FileText,
  },
  {
    title: "Product Recommendation",
    desc: "Match customer needs to the right panel / line.",
    icon: Package,
  },
  {
    title: "Quotation Support",
    desc: "Assist pricing with region, volume & margin logic.",
    icon: DollarSign,
  },
  {
    title: "Technical Comparison",
    desc: "PIR vs Rock Wool, U-values, fire class, cost.",
    icon: BarChart3,
  },
  {
    title: "Customer FAQ",
    desc: "Instant answers for common technical & sales questions.",
    icon: MessageCircle,
  },
];
...
function Chip({
  ...
  return (
    <span
      className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-[11px] font-medium ring-1 ${map[tone]}`}
    >
      {children}
    </span>
  );
      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative mx-auto max-w-[1440px] px-6 py-14 md:py-20">
          ...
          <div className="mt-6 flex flex-wrap gap-6 text-sm text-white/60">
            <div>
              <span className="text-white font-semibold text-lg">85+</span> Countries
            </div>
            <div>
              <span className="text-white font-semibold text-lg">320+</span> Partners
            </div>
            <div>
              <span className="text-white font-semibold text-lg">1,500+</span> Projects
            </div>
            <div>
              <span className="text-white font-semibold text-lg">25,000+</span> Customers
            </div>
          </div>
        </div>
      </section>
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start">
              <Card className="p-3">
                  ...
                  {NAV.map((n) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <ChevronRight
                          className={`h-3.5 w-3.5 transition ${on ? "translate-x-0.5 text-emerald-300" : "text-white/30"}`}
                        />
                      </button>
                    );
                  })}
                ...
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-white/50 hover:bg-white/5"
                >
            ...
            <main className="min-w-0">
              ...
              <div className="mb-6 flex flex-wrap items-center gap-3">
                ...
                <button className="relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] text-white/70 hover:bg-white/5">
                  ...
                  <span className="absolute -right-1 -top-1 grid h-4 w-4 place-items-center rounded-full bg-emerald-500 text-[10px] font-bold text-black">
                    7
                  </span>
                </button>
          ...
          <div className="grid gap-8 md:grid-cols-[1.4fr_1fr] md:items-center">
            <div>
              <div className="text-xs uppercase tracking-[0.2em] text-emerald-300/90">
                Ready to partner with NEVO?
              </div>
              <h2 className="mt-3 text-3xl font-semibold md:text-5xl">
                Become a <span className="text-emerald-400">NEVO Partner</span>.
              </h2>
              <p className="mt-4 max-w-xl text-white/70">
                Join a global industrial engineering network with the technical, commercial and
                marketing support you need to close larger projects — faster.
              </p>
            </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr]">
        <Card className="overflow-hidden">
          <div className="relative aspect-[16/10] w-full">
            <img
              ...
              decoding="async"
              src={A[6].url}
              alt="Global partner network map"
            ...
            <div className="absolute bottom-5 left-5 right-5">
              ...
              <div className="mt-1 text-lg font-semibold">
                Strong Partners. Global Growth. Shared Success.
              </div>
            </div>
          </div>
        ...
        <Card className="p-7 md:p-9">
          ...
          >
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2.5">
                ...
                <input
                  required
                  type="email"
                  defaultValue="partner@nevo-industrial.com"
                  className="w-full bg-transparent text-sm outline-none"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 py-3 text-sm font-semibold text-black hover:bg-emerald-400"
            >
              <LogIn className="h-4 w-4" /> Sign in to Portal
            </button>
            <div className="flex items-center justify-center gap-2 text-[11px] text-white/50">
              <ShieldCheck className="h-3.5 w-3.5 text-emerald-300" /> Two-Factor Authentication
              Ready
            </div>
          </form>
        </Card>
...
function SalesChart() {
  ...
  const path = pts
    .map((v, i) => `${i === 0 ? "M" : "L"} ${i * step} ${h - (v / max) * (h - 20)}`)
    .join(" ");
          ...
          <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-2 py-1">
            ...
            {stages.map((s) => (
              <button
                key={s}
                onClick={() => setStage(s)}
                className={`rounded-lg px-2.5 py-1 text-xs ${stage === s ? "bg-emerald-500 text-black font-semibold" : "text-white/60 hover:bg-white/5"}`}
              >
                {s}
              </button>
            ))}
          ...
          <Card key={p.title} className="group overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="mt-3 flex items-center gap-3 text-xs">
                <button className="inline-flex items-center gap-1 text-emerald-300 hover:text-emerald-200">
                  Technical Specs <ExternalLink className="h-3 w-3" />
                </button>
                <span className="text-white/20">·</span>
                <button className="inline-flex items-center gap-1 text-emerald-300 hover:text-emerald-200">
                  Certificates <ExternalLink className="h-3 w-3" />
                </button>
              </div>
            </div>
          </Card>
      ...
      <Card className="p-5">
        ...
        <div className="overflow-hidden rounded-xl border border-white/5">
          ...
          {[
            ...
            <div
              key={r[0]}
              className="grid grid-cols-[1.4fr_1fr_1fr_.6fr] items-center border-t border-white/5 px-5 py-3 text-sm"
            >
              <div className="text-white/90">{r[0]}</div>
              <div className="text-white/60">{r[1]}</div>
              <div className="text-white/60">{r[2]}</div>
              <div className="flex justify-end">
                <button className="rounded-lg bg-emerald-500/10 p-1.5 text-emerald-300 ring-1 ring-emerald-500/30 hover:bg-emerald-500/20">
        ...
        <div className="grid gap-0 md:grid-cols-[1fr_1.1fr]">
          ...
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-white/60">
              Brand assets, presentations, brochures and campaign material — all co-brandable for
              your market.
            </p>
            <div className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-2">
              {MARKETING.map((m) => {
                ...
                return (
                  <button
                    key={m.title}
                    className="flex items-center justify-between rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-left text-sm hover:bg-white/5"
                  >
                    <span className="flex items-center gap-3">
                      <Icon className="h-4 w-4 text-emerald-300" />
                      {m.title}
        ...
        <div className="relative aspect-[21/8]">
          ...
          <div className="absolute bottom-5 left-6 right-6">
            ...
            <div className="mt-1 text-2xl font-semibold">
              Expand your knowledge. Earn certifications.
            </div>
          </div>
        </div>
      </Card>
        ...
        {TRAINING.map((c, i) => (
          <Card key={c.title} className="p-5">
            ...
            <div className="mt-4 flex items-center gap-2">
              <button className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-3 py-1.5 text-xs font-semibold text-black hover:bg-emerald-400">
                <Play className="h-3.5 w-3.5" /> Start
              </button>
              <button className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-3 py-1.5 text-xs text-white/80 hover:bg-white/5">
    ...
    <div className="space-y-4">
        ...
        <div className="grid gap-0 md:grid-cols-[1.1fr_1fr]">
          <div className="p-6">
            ...
            <h3 className="mt-2 text-2xl font-semibold">
              Technical documents & engineering files.
            </h3>
            <p className="mt-2 text-sm text-white/60">
              CAD, BIM, drawings, datasheets, installation manuals and engineering guides.
            </p>
          </div>
          <div className="relative aspect-[4/3] md:aspect-auto">
            <img
      ...
      <Card className="overflow-hidden">
        ...
        {DOWNLOADS.map((d) => (
          <div
            key={d.title}
            className="grid grid-cols-[1.4fr_.6fr_.6fr_.6fr] items-center gap-3 border-b border-white/5 px-5 py-3 text-sm last:border-0"
          >
            ...
            <div>
              <Chip tone="muted">{d.type}</Chip>
            </div>
            <div className="text-white/60">{d.size}</div>
            <div className="flex justify-end">
              <button className="inline-flex items-center gap-1 rounded-lg bg-emerald-500/10 px-2.5 py-1 text-xs text-emerald-300 ring-1 ring-emerald-500/30 hover:bg-emerald-500/20">
    ...
    <div className="space-y-4">
      <Card className="overflow-hidden">
        <div className="relative aspect-[21/7]">
          ...
          <div className="absolute bottom-5 left-6 right-6">
            ...
            <div className="mt-1 text-2xl font-semibold">
              We're here to support you — every channel, every timezone.
            </div>
          </div>
        </div>
      </Card>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {channels.map(({ t, d, i: Icon }) => (
          <Card key={t} className="p-5 hover:bg-white/[0.05]">
            <div className="grid h-10 w-10 place-items-center rounded-xl bg-emerald-500/10 ring-1 ring-emerald-500/30">
              <Icon className="h-5 w-5 text-emerald-300" />
            </div>
      ...
      <Card className="p-5">
        <div className="mb-3 flex items-center justify-between text-sm">
          ...
          <Chip tone="muted">
            <Calendar className="mr-1 inline h-3 w-3" /> Upcoming
          </Chip>
        </div>
          ...
          <div className="flex h-40 items-end gap-2">
            {bars.map((v, i) => (
              <div key={i} className="flex-1">
                <div
                  className="rounded-t-md bg-gradient-to-t from-emerald-500/30 to-emerald-400"
        ...
        <Card className="p-5">
          ...
          <ul className="space-y-3 text-sm">
            {TERRITORIES.map((t) => (
              <li key={t.r}>
                <div className="flex items-center justify-between">
                  <span className="text-white/80">{t.r}</span>
                  <span className="text-white/60">
                    {t.rev} · Conv {t.conv}
                  </span>
                </div>
                <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-white/5">
                  <div className="h-full bg-emerald-500" style={{ width: t.conv }} />
                </div>
              </li>
            ))}
          </ul>
      ...
      <Card className="overflow-hidden">
        <div className="grid gap-0 md:grid-cols-[1fr_1.1fr]">
          ...
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-white/60">
              Draft proposals, price quotes and technical comparisons in seconds — trained on NEVO
              products.
            </p>
            <div className="mt-5 grid grid-cols-1 gap-2">
              {AI_TOOLS.map((t) => {
                ...
                return (
                  <button
                    key={t.title}
                    className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-left text-sm hover:bg-white/5"
                  >
                    <div className="grid h-9 w-9 place-items-center rounded-lg bg-emerald-500/10 ring-1 ring-emerald-500/30">
                      <Icon className="h-4 w-4 text-emerald-300" />
                    </div>
                    <div className="flex-1">
    ...
    <Card className="overflow-hidden">
      <div className="grid gap-0 md:grid-cols-[1.2fr_1fr]">
        ...
        <div className="p-6">
          ...
          <p className="mt-2 text-sm text-white/60">
            Responsive dashboard, quick actions and push notifications — iOS & Android.
          </p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <button className="rounded-xl bg-white/[0.06] px-4 py-2 text-xs font-semibold ring-1 ring-white/10 hover:bg-white/10">
