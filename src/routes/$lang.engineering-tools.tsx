        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Are the NEVO engineering tools free to use?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. All 20 engineering calculators are free. You can export PDF reports, share results and request a full engineering proposal.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "The tools use industry-standard formulas (EN 14509, EN 13501-1, ASTM) calibrated against NEVO's production data. Results are engineering estimates suitable for feasibility and pre-design.",
                },
              },
              {
                "@type": "Question",
                name: "Can I get an engineer to review my results?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes — after any calculation you can request a proposal and a senior industrial engineer will review your inputs within 24 hours.",
                },
              },
            ],
          }),
...
const TOOLS: Tool[] = [
  {
    slug: "panel-thickness",
    title: "Panel Thickness Calculator",
    desc: "Recommended thickness by application, climate, fire and temperature.",
    icon: Ruler,
    category: "Panels",
  ...
  },
  {
    ...
    desc: "Thermal transmittance for PIR, rock wool and EPS across thickness.",
    icon: Thermometer,
    category: "Panels",
    metric: "W/m²K",
  },
  {
    slug: "fire-rating",
    title: "Fire Rating Estimator",
    desc: "Reaction-to-fire and integrity/insulation estimate per EN 13501.",
    icon: Flame,
    category: "Panels",
    metric: "EI 30–240",
  },
  {
    ...
    desc: "Weight per m² and per panel — steel + core density.",
    icon: Weight,
    category: "Panels",
    metric: "kg / m²",
  },
  {
    ...
    desc: "Annual m² output by line speed, shifts and OEE.",
    icon: Factory,
    category: "Factory",
    featured: true,
    metric: "m² / year",
  ...
  {
    slug: "investment",
    title: "Factory Investment Calculator",
    desc: "Full CAPEX, OPEX, ROI, IRR, NPV and payback model.",
    icon: Wallet,
    category: "Financial",
  ...
  },
  {
    ...
    desc: "Return on investment, IRR and payback for a panel factory.",
    icon: TrendingUp,
    category: "Financial",
    metric: "%",
  },
  {
    slug: "utility",
    title: "Utility Consumption Calculator",
    desc: "Electricity, gas, water and compressed air per m² of panel.",
    icon: Zap,
    category: "Factory",
    metric: "kWh / m²",
  },
  {
    slug: "coil",
    title: "Steel Coil Weight Calculator",
    desc: "Coil weight, linear meters and panels per coil.",
    icon: Package,
    category: "Logistics",
    metric: "kg / m",
  },
  {
    slug: "chemical",
    title: "Chemical Consumption Calculator",
    desc: "Polyol, isocyanate and additives per m³ of PIR foam.",
    icon: FlaskConical,
    category: "Factory",
    metric: "kg / m³",
  },
  {
    slug: "roof",
    title: "Roof Panel Selector",
    desc: "Best roof panel profile for span, snow and wind loads.",
    icon: Home,
    category: "Selectors",
  },
  {
    slug: "wall",
    title: "Wall Panel Selector",
    desc: "Best wall panel for façade type, fire and thermal targets.",
    icon: LayoutGrid,
    category: "Selectors",
  },
  {
    slug: "cold",
    title: "Cold Room Panel Selector",
    desc: "Panel for freezer, chiller and blast rooms −40 °C to +5 °C.",
    icon: Snowflake,
    category: "Selectors",
  },
  {
    slug: "clean",
    title: "Clean Room Panel Selector",
    desc: "GMP class panel — flush profile, HPL, pharma & food.",
    icon: Sparkles,
    category: "Selectors",
  },
  {
    slug: "layout",
    title: "Factory Layout Planner",
  ...
  },
  {
    ...
    desc: "Steel, chemicals, adhesives per m² of finished panel.",
    icon: Boxes,
    category: "Factory",
    metric: "kg / m²",
  },
  {
    ...
    desc: "Cost per m² — materials, labor, utilities, overhead.",
    icon: DollarSign,
    category: "Financial",
    metric: "USD / m²",
  },
  {
    ...
    desc: "Total budget for a complete panel factory project.",
    icon: ClipboardList,
    category: "Financial",
  },
  {
    ...
    desc: "Panels per 20'/40' HC container and total containers.",
    icon: Container,
    category: "Logistics",
  },
  {
    ...
    desc: "Ask any engineering question — panels, lines, utilities.",
    icon: Bot,
    category: "AI",
    href: "/ai-assistant",
    featured: true,
      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-28 pb-24">
          ...
          <p className="mt-6 max-w-2xl text-lg text-white/60 leading-relaxed">
            Professional engineering software for the sandwich panel industry. Twenty calculators —
            panel thickness, U-value, fire rating, capacity, investment, ROI, utilities, layout —
            with instant AI recommendations and PDF reports.
          </p>
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            >
              <Link to="/investment-calculator">
                Calculate Your Factory <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button
              asChild
              variant="outline"
              className="border-white/15 bg-white/[0.03] hover:bg-white/[0.06] h-12 px-6"
            >
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-px bg-white/5 border border-white/5 rounded-2xl overflow-hidden">
            {[
              ...
              <div key={m.v} className="bg-[#0a0d10] p-6">
                ...
                <div className="mt-1 text-[11px] font-mono uppercase tracking-widest text-white/50">
                  {m.v}
                </div>
              </div>
            ))}
            ...
            {filtered.map((t) => {
              ...
              const inner = (
                ...
                >
                  ...
                  <h3 className="mt-5 text-lg font-semibold tracking-tight group-hover:text-emerald-300 transition">
                    {t.title}
                  </h3>
              ...
              return t.href ? (
                <Link key={t.slug} to={t.href} className="block h-full">
                  {inner}
                </Link>
              ) : (
                <button
        ...
        <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-[1.1fr_1fr] gap-12 items-center">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight">
              Every result — reviewed by a senior industrial engineer
            </h2>
            <p className="mt-4 text-white/60 leading-relaxed">
              After each calculation, our AI engineer explains the result, recommends the best
              production line, the right panel type, the utilities you'll need and a phased plan for
              future expansion.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                asChild
                className="bg-emerald-500 hover:bg-emerald-400 text-black font-semibold h-11"
              >
                <Link to="/ai-assistant">
                  Open AI Engineer <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight">
            About the engineering tools
          </h2>
          <div className="mt-10 divide-y divide-white/5 border-y border-white/5">
            {[
              {
                q: "Are the NEVO engineering tools free to use?",
                a: "Yes. All 20 engineering calculators are free. You can export PDF reports, share results and request a full engineering proposal at no cost.",
              },
              {
                q: "How accurate are the calculations?",
                a: "The tools use industry-standard formulas (EN 14509, EN 13501-1, ASTM) calibrated against NEVO's production data. Results are engineering estimates suitable for feasibility and pre-design; final design is validated by our engineering team.",
              },
              {
                q: "Can I get an engineer to review my results?",
                a: "Yes — after any calculation you can request a proposal and a senior industrial engineer will review your inputs and reply within 24 hours.",
              },
              {
                q: "Can I export and share the results?",
                a: "Yes. Every tool supports PDF export, share links and email reports.",
              },
            ].map((f) => (
      ...
      <section className="border-t border-white/5 py-24">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tight">
            Ready to engineer your factory?
          </h2>
          <p className="mt-4 text-white/60 max-w-2xl mx-auto">
            Run the numbers, get an AI review, then talk to a senior engineer. From feasibility to
            commissioning — one platform.
          </p>
    ...
    >
      ...
      >
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          <Button
            asChild
            className="bg-emerald-500 hover:bg-emerald-400 text-black font-semibold h-10"
          >
            <Link to="/project-inquiry">Request Engineering Proposal</Link>
          </Button>
...
function MiniCompute({ slug }: { slug: string }) {
  ...
  switch (slug) {
    case "u-value":
      return <UValueMini />;
    case "fire-rating":
      return <FireRatingMini />;
    case "panel-weight":
      return <PanelWeightMini />;
    case "capacity":
      return <CapacityMini />;
    case "roi":
      return <RoiMini />;
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <label className="block">
      <span className="block text-[10px] font-mono uppercase tracking-widest text-white/50 mb-1.5">
        {label}
      </span>
      {children}
    </label>
...
function NumInput(props: React.InputHTMLAttributes<HTMLInputElement>) {
  return (
    <input
      type="number"
      {...props}
      className={`w-full rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-sm focus:outline-none focus:border-emerald-500/50 ${props.className ?? ""}`}
    />
  );
}
function Select({
  ...
  return (
    <select
      ...
      className="w-full rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-sm focus:outline-none focus:border-emerald-500/50"
    >
      {options.map((o) => (
...
function UValueMini() {
  ...
  const rec =
    u < 0.25 ? "cold storage / freezer" : u < 0.4 ? "chiller / clean room" : "industrial building";
  return (
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Core">
          <Select value={core} onChange={setCore} options={["PIR", "Rock Wool", "EPS"]} />
        </Field>
        <Field label="Thickness (mm)">
          <NumInput value={th} onChange={(e) => setTh(+e.target.value)} min={40} max={240} />
        </Field>
      </div>
      ...
      <AiHint
        text={`At ${th} mm ${core}, U = ${u.toFixed(3)} W/m²K — ideal for ${rec}. Pair with a continuous ${core === "PIR" ? "PIR" : "mineral wool"} line at 8–12 m/min for consistent thermal quality.`}
      />
    </div>
  );
}
...
function FireRatingMini() {
  ...
  const ei =
    core === "Rock Wool"
      ? Math.min(240, Math.round(th * 1.8))
      : core === "PIR"
        ? Math.min(90, Math.round(th * 0.6))
        : 15;
  return (
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Core">
          <Select value={core} onChange={setCore} options={["Rock Wool", "PIR", "EPS"]} />
        </Field>
        <Field label="Thickness (mm)">
          <NumInput value={th} onChange={(e) => setTh(+e.target.value)} min={50} max={240} />
        </Field>
      </div>
      <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <AiHint
        text={`${core} at ${th} mm reaches ${reaction} and EI ${ei}. For petrochemical, tunnel or high-rise use rock wool. For cold storage where fire load is low, PIR delivers superior thermal performance.`}
      />
    </div>
  );
}
  ...
  return (
    <div className="mt-6">
      <div className="grid grid-cols-3 gap-3">
        ...
        <Field label="Thickness (mm)">
          <NumInput value={th} onChange={(e) => setTh(+e.target.value)} />
        </Field>
        <Field label="Steel (mm)">
          <NumInput step={0.05} value={steel} onChange={(e) => setSteel(+e.target.value)} />
        </Field>
      </div>
      <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <AiHint
        text={`Weight of ${w.toFixed(1)} kg/m² is typical for a ${th} mm ${core} panel with ${steel} mm skins — dimension your lifting equipment and truck loads accordingly.`}
      />
    </div>
  );
}
    ...
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Line speed (m/min)">
          <NumInput value={speed} onChange={(e) => setSpeed(+e.target.value)} />
        </Field>
        <Field label="Panel width (m)">
          <NumInput step={0.05} value={width} onChange={(e) => setWidth(+e.target.value)} />
        </Field>
        <Field label="Shifts / day">
          <NumInput value={shifts} onChange={(e) => setShifts(+e.target.value)} min={1} max={3} />
        </Field>
        <Field label="OEE (%)">
          <NumInput value={oee} onChange={(e) => setOee(+e.target.value)} min={40} max={95} />
        </Field>
      </div>
      <div className="mt-4 grid grid-cols-2 gap-3">
        <ResultCard
          label="Daily output"
          value={Math.round(daily).toLocaleString()}
          unit="m² / day"
        />
        <ResultCard
          label="Annual output"
          value={Math.round(yearly).toLocaleString()}
          unit="m² / year"
        />
      </div>
      <AiHint
        text={`At ${speed} m/min with ${shifts} shifts and ${oee}% OEE you reach ~${(yearly / 1e6).toFixed(2)} M m²/year. Recommend a NEVO ${speed < 8 ? "Compact" : speed < 14 ? "Standard" : "High-Speed"} continuous line and a 2-shift maintenance rotation.`}
      />
    </div>
  );
}
...
function RoiMini() {
  ...
  return (
    <div className="mt-6">
      <div className="grid grid-cols-3 gap-3">
        <Field label="CAPEX (M USD)">
          <NumInput value={capex} onChange={(e) => setCapex(+e.target.value)} />
        </Field>
        <Field label="Revenue (M USD/yr)">
          <NumInput value={rev} onChange={(e) => setRev(+e.target.value)} />
        </Field>
        <Field label="EBITDA margin (%)">
          <NumInput value={margin} onChange={(e) => setMargin(+e.target.value)} />
        </Field>
      </div>
      ...
      <AiHint
        text={`Payback of ${payback.toFixed(1)} years is ${payback < 4 ? "excellent" : payback < 6 ? "healthy" : "long — consider a higher-speed line or a second shift"}. For a 10-year horizon the investment returns ${roi.toFixed(0)}% cumulative.`}
      />
    </div>
  );
}
...
function UtilityMini() {
  ...
  return (
    <div className="mt-6">
      <Field label="Annual production (m²/yr)">
        <NumInput value={m2} onChange={(e) => setM2(+e.target.value)} />
      </Field>
      <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <AiHint
        text={`For ${(m2 / 1e6).toFixed(2)} M m²/yr size the transformer at ~${Math.round(power / 8000)} kVA and a ${Math.round(air / 20000)} m³/min compressor room. Recommend heat-recovery on the oven for 12–18% gas savings.`}
      />
    </div>
  );
}
...
function CoilMini() {
  ...
  return (
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Coil width (m)">
          <NumInput step={0.05} value={w} onChange={(e) => setW(+e.target.value)} />
        </Field>
        <Field label="Steel thickness (mm)">
          <NumInput step={0.05} value={t} onChange={(e) => setT(+e.target.value)} />
        </Field>
        <Field label="Inner Ø (mm)">
          <NumInput value={id} onChange={(e) => setId(+e.target.value)} />
        </Field>
        <Field label="Outer Ø (mm)">
          <NumInput value={od} onChange={(e) => setOd(+e.target.value)} />
        </Field>
      </div>
      <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <AiHint
        text={`A ${Math.round(weight).toLocaleString()} kg coil feeds ~${Math.round(length).toLocaleString()} m of panel. Plan two decoilers to overlap coil changes and keep line utilisation above 90%.`}
      />
    </div>
  );
}
...
function ChemicalMini() {
  ...
  return (
    <div className="mt-6">
      <Field label="PIR foam volume (m³/yr)">
        <NumInput value={m3} onChange={(e) => setM3(+e.target.value)} />
      </Field>
      <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <AiHint
        text={`Recommend two 50 m³ heated tanks (polyol + MDI) and a high-pressure mixing head calibrated at 130 bar. Nitrogen blanketing on MDI is mandatory.`}
      />
    </div>
  );
}
...
function MaterialMini() {
  ...
  return (
    <div className="mt-6">
      ...
      <AiHint
        text={`Secure two steel suppliers to hedge coil price; keep 45–60 days of chemical stock. Recommend NEVO's supply desk to lock long-term pricing.`}
      />
    </div>
  );
}
...
function CostMini() {
  ...
  return (
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Materials (USD/m²)">
          <NumInput step={0.1} value={mat} onChange={(e) => setMat(+e.target.value)} />
        </Field>
        <Field label="Labor (USD/m²)">
          <NumInput step={0.1} value={lab} onChange={(e) => setLab(+e.target.value)} />
        </Field>
        <Field label="Utilities (USD/m²)">
          <NumInput step={0.1} value={util} onChange={(e) => setUtil(+e.target.value)} />
        </Field>
        <Field label="Overhead (USD/m²)">
          <NumInput step={0.1} value={ovh} onChange={(e) => setOvh(+e.target.value)} />
        </Field>
      </div>
      <div className="mt-4">
      ...
      <AiHint
        text={`At ${total.toFixed(2)} USD/m² total cost, target a 35–45% gross margin on standard PIR wall panels. Automation can cut labor by ~30%.`}
      />
    </div>
  );
}
...
function BudgetMini() {
  ...
  return (
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Production line (M USD)">
          <NumInput step={0.1} value={line} onChange={(e) => setLine(+e.target.value)} />
        </Field>
        <Field label="Building (M USD)">
          <NumInput step={0.1} value={bldg} onChange={(e) => setBldg(+e.target.value)} />
        </Field>
        <Field label="Utilities (M USD)">
          <NumInput step={0.1} value={util} onChange={(e) => setUtil(+e.target.value)} />
        </Field>
        <Field label="Working capital (M USD)">
          <NumInput step={0.1} value={wc} onChange={(e) => setWc(+e.target.value)} />
        </Field>
      </div>
      <div className="mt-4">
      ...
      <AiHint
        text={`A ${total.toFixed(1)} M USD project is typical for a 1 M m²/yr NEVO continuous line. Phase in a second line at Year 3 to double capacity with ~55% incremental capex.`}
      />
    </div>
  );
}
    ...
    <div className="mt-6">
      <div className="grid grid-cols-2 gap-3">
        <Field label="Panel quantity">
          <NumInput value={panels} onChange={(e) => setPanels(+e.target.value)} />
        </Field>
        <Field label="Panel length (m)">
          <NumInput value={len} onChange={(e) => setLen(+e.target.value)} />
        </Field>
      </div>
      <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <AiHint
        text={`Recommend flat-rack containers for panels above 12 m and a break-bulk vessel above 40 containers to save 18–25% freight.`}
      />
    </div>
  );
}
...
function SelectorMini({ slug }: { slug: string }) {
  const map: Record<string, { core: string; th: number; profile: string; note: string }> = {
    roof: {
      core: "PIR",
      th: 80,
      profile: "5-rib trapezoidal",
      note: "Optimal for spans up to 5.5 m under EU snow loads.",
    },
    wall: {
      core: "PIR",
      th: 100,
      profile: "Micro-rib hidden fix",
      note: "Best for industrial façades with clean aesthetics.",
    },
    cold: {
      core: "PIR",
      th: 150,
      profile: "Flush cam-lock",
      note: "For −25 °C freezer rooms; U ≈ 0.15 W/m²K.",
    },
    clean: {
      core: "Rock Wool",
      th: 100,
      profile: "Flush GMP",
      note: "Hospital / pharma cleanrooms — A2 fire, hygienic finish.",
    },
  };
  const r = map[slug];
  return (
