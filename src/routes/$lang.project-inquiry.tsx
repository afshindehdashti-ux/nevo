...
const PROJECT_TYPES = [
  {
    id: "new-factory",
    label: "Build a New Factory",
    desc: "Greenfield sandwich panel factory from concept to commissioning.",
    icon: Factory,
    img: tile10,
  },
  {
    id: "upgrade",
    label: "Upgrade an Existing Factory",
    desc: "Audit, debottleneck and modernize a running plant.",
    icon: Wrench,
    img: tile13,
  },
  {
    ...
    desc: "Continuous PIR / Rock Wool lines, roll forming, cutting, stacking.",
    icon: Cog,
    img: tile14,
  },
  {
    id: "raw-materials",
    label: "Raw Materials",
    desc: "PPGI / GI / Aluzinc coils, PIR chemistry, rock wool, adhesives.",
    icon: Boxes,
    img: tile19,
  },
  {
    id: "panels",
    label: "Finished Sandwich Panels",
    desc: "PIR, Rock Wool, wall, roof and cold-room panels — engineered supply.",
    icon: Layers,
    img: tile22,
  },
  {
    ...
    desc: "Feasibility, master plan, layout, process, utilities, automation.",
    icon: Building2,
    img: tile08,
  },
  {
    id: "automation",
    label: "Automation",
    desc: "PLC/SCADA, MES, quality control and smart factory integration.",
    icon: Cpu,
    img: tile11,
  },
  {
    ...
    desc: "Remote diagnostics, spare parts, operator training, optimization.",
    icon: LifeBuoy,
    img: tile18,
  },
];
...
const WHY_NEVO = [
  {
    ...
    desc: "Every proposal is engineered — never templated. Real capacity, real utilities, real cost per m².",
    icon: Sparkles,
  },
  {
    title: "Global Supply Chain",
    desc: "Coils, chemistry, machinery and spare parts sourced from tier-1 mills and OEMs worldwide.",
    icon: Globe2,
  },
  {
    title: "Dubai Headquarters",
    desc: "Central time zone for EMEA, Africa, CIS and South Asia — fast decisions, one accountable partner.",
    icon: MapPin,
  },
  {
    title: "Worldwide Support",
    desc: "Commissioning, training and remote diagnostics on active projects across four continents.",
    icon: Headphones,
  },
  {
    title: "Complete Industrial Solutions",
    desc: "Factory, line, raw materials, panels, automation and after-sales under one engineering roof.",
    icon: Factory,
  },
  {
    title: "Long-Term Partnership",
    desc: "We stay after handover — optimization, upgrades and expansions for the life of the plant.",
    icon: Handshake,
  },
];
...
const WHAT_NEXT = [
  {
    t: "Project Review",
    d: "We read your intake, drawings and RFQ in detail — no auto-replies.",
    icon: ClipboardCheck,
  },
  {
    t: "Technical Evaluation",
    d: "Engineers evaluate capacity, layout, utilities and feasibility.",
    icon: Search,
  },
  {
    t: "Engineering Meeting",
    d: "Video call with process, mechanical and automation leads.",
    icon: Users,
  },
  {
    t: "Proposal Preparation",
    d: "Technical proposal, scope of supply, drawings and assumptions.",
    icon: FileText,
  },
  {
    t: "Quotation",
    d: "Commercial offer with payment terms, delivery and warranty.",
    icon: FileSignature,
  },
  {
    t: "Project Kick-Off",
    d: "Contract signature, engineering release, production scheduling.",
    icon: Flag,
  },
];
...
const FAQS: { q: string; a: string }[] = [
  {
    q: "How long does proposal preparation take?",
    a: "A first engineering proposal takes 5–10 working days after we receive a completed intake. Complex greenfield factories may require 3–4 weeks including a discovery call.",
  },
  {
    q: "Do I need to fill in every field to submit?",
    a: "No. Company, contact, project type and a short description are enough to start. The more technical detail you share, the more accurate the first proposal.",
  },
  {
    q: "Can I upload drawings, RFQs and CAD files?",
    a: "Yes. PDF, DWG, DXF, STEP, IFC, images and ZIP archives up to 50 MB per file. Larger sets — request a secure upload link.",
  },
  {
    q: "Do you sign NDAs?",
    a: "Yes. We can sign your NDA or issue ours before any technical exchange. Request it in the additional information field.",
  },
  {
    q: "Can NEVO review an existing factory?",
    a: "Yes. We run technical audits on running plants — OEE, changeover, curing, cutting, packing, utilities — and issue an upgrade roadmap.",
  },
  {
    q: "Do you provide turnkey projects?",
    a: "Yes. From feasibility and building to commissioning and operator training, delivered as a single engineered scope.",
  },
  {
    q: "Can you engineer only the factory building?",
    a: "Yes. We can engineer the shell, layout and utilities even when the production line is sourced elsewhere.",
  },
  {
    q: "Which industries do you serve?",
    a: "Cold storage, food, pharma, clean rooms, logistics, data centers, industrial and commercial buildings, modular construction, agriculture and transport facilities.",
  },
  {
    q: "Do you supply raw materials only?",
    a: "Yes. PPGI / GI / Aluzinc coils, PIR polyol & MDI, rock wool slabs, adhesives and sealants — engineered supply with QA documentation.",
  },
  {
    q: "What is the minimum project size?",
    a: "There is no hard minimum for consultancy or raw materials. For turnkey factories, projects typically start around 1M m²/year of installed capacity.",
  },
  {
    q: "Do you work on projects outside the Middle East?",
    a: "Yes. Active projects and clients in UAE, Saudi Arabia, Oman, Iraq, Turkey, Russia, Kenya, Cameroon and beyond.",
  },
  {
    q: "How is pricing structured?",
    a: "Fixed-price engineering packages, CIF/FOB for materials and machinery, milestone-based payments for turnkey factories. All terms defined in the commercial offer.",
  },
  {
    q: "Can you help with financing?",
    a: "We support your bank or ECA package with technical documentation, capex breakdown, ROI and payback modeling — we do not provide financing directly.",
  },
  {
    q: "What warranty do you offer?",
    a: "12–24 months mechanical warranty on machinery, 10-year performance warranty on sandwich panels, and long-term technical support agreements on request.",
  },
  {
    q: "Do you provide operator training?",
    a: "Yes. On-site and remote training programs for line operators, maintenance, quality and production management.",
  },
  {
    q: "Can you commission an existing line we bought elsewhere?",
    a: "Yes. We commission or re-commission third-party lines, including automation retrofits and quality upgrades.",
  },
  {
    q: "Do you handle installation and civil works?",
    a: "We supervise installation and civil works through vetted local partners, or coordinate with your appointed contractor.",
  },
  {
    q: "How do I know my data is safe?",
    a: "Intake data is encrypted in transit, stored on access-controlled systems and shared only with the engineers assigned to your inquiry.",
  },
  {
    q: "Can I book a call before submitting?",
    a: "Yes. Choose Talk to an Engineer or Book Engineering Consultation to schedule a call directly with our engineering team.",
  },
  {
    q: "What happens after project kick-off?",
    a: "You get a dedicated project manager, weekly engineering reports, milestone reviews and continuous access to the technical team through project handover.",
  },
  {
    q: "Do you offer long-term technical support after commissioning?",
    a: "Yes. Annual support agreements cover remote diagnostics, spare parts, preventive maintenance and periodic performance audits.",
  },
];
...
const DOWNLOADS = [
  {
    ...
    desc: "Everything to prepare before the first engineering call.",
    icon: ClipboardCheck,
  },
  {
    title: "Engineering Questionnaire",
    desc: "Full technical intake in PDF form for offline completion.",
    icon: FileText,
  },
  {
    title: "Factory Data Sheet",
    desc: "Site, utilities and capacity data template.",
    icon: Layers,
  },
  {
    title: "Technical Requirements Guide",
    desc: "How NEVO structures a factory engineering scope.",
    icon: FileSignature,
  },
];
  ...
  const submit = async () => {
    ...
    if (!form.company.trim() || !form.contact.trim() || !emailOk) {
      toast.error("Please complete required fields", {
        description:
          "Company, contact person, and a valid work email are required before submission.",
      });
      setStep(0);
      return;
    }
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[80vh] w-full overflow-hidden bg-[#0B0D10] text-white">
        <div className="absolute inset-0">
          <img
            ...
            decoding="async"
            src={heroImg}
            alt="NEVO engineering — 3D factory render"
        ...
        <div className="relative mx-auto flex min-h-[80vh] max-w-[1440px] flex-col justify-end px-6 pb-20 pt-40 md:pb-28 md:pt-48">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg text-white/75 md:text-xl">
              Tell us about your project and our engineering team will prepare the right technical
              solution — feasibility, factory, line, panels or full turnkey.
            </p>
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              >
                <a href="#contact-options">
                  <MessageCircle className="mr-2 h-4 w-4" /> Talk to an Engineer
                </a>
              </Button>
            </div>
            <div className="mt-8 flex flex-wrap items-center gap-6 text-xs uppercase tracking-widest text-white/50">
              <span className="flex items-center gap-2">
                <ShieldCheck className="h-3.5 w-3.5 text-emerald-400" /> NDA on Request
              </span>
              <span className="flex items-center gap-2">
                <Sparkles className="h-3.5 w-3.5 text-emerald-400" /> Engineering Proposal in 5–10
                Days
              </span>
              <span className="flex items-center gap-2">
                <Globe2 className="h-3.5 w-3.5 text-emerald-400" /> Projects on 4 Continents
              </span>
            </div>
          </motion.div>
        </div>
          ...
          <div className="mx-auto flex max-w-[1200px] flex-col gap-4 rounded-2xl border border-emerald-500/30 bg-background p-6 md:flex-row md:items-start md:justify-between">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                We received your selections from the NEVO engineering tools. Our team will use this
                as the starting point for your recommendation.
              </p>
          ...
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-xl text-white/70">
                Seven short steps. Autosaved as you go. Skip fields you don't have — our engineers
                will follow up.
              </p>
            </div>
            ...
            <div className="mt-4 hidden grid-cols-7 gap-2 text-[11px] uppercase tracking-widest text-white/50 md:grid">
              {STEPS.map((s, i) => (
                <button
                  key={s}
                  onClick={() => setStep(i)}
                  className={`text-left transition-colors ${i <= step ? "text-emerald-400" : "hover:text-white/80"}`}
                >
                  0{i + 1} · {s}
                </button>
              ))}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {step === 2 && (
                    <StepGrid>
                      <TextField
                        ...
                        placeholder="e.g. 2,000,000 m²/year"
                      />
                      <SelectField
                        label="Panel Type"
                      ...
                      <TextField
                        ...
                        placeholder="e.g. 40–150 mm"
                      />
                      <SelectField
                        label="Steel Type"
                        value={form.steelType}
                        onChange={(v) => update("steelType", v)}
                        options={STEEL_TYPES}
                      />
                      <SelectField
                  ...
                  {step === 3 && (
                    <div>
                      <div className="text-xs uppercase tracking-widest text-white/60">
                        Select all engineering scopes you need
                      </div>
                        ...
                        {ENGINEERING_REQS.map((r) => {
                          ...
                          return (
                            <button
                              key={r}
                              type="button"
                              onClick={() => toggleArray("engineering", r)}
                            ...
                            >
                              ...
                              {active ? (
                                ...
                                <span className="h-4 w-4 rounded-sm border border-white/30" />
                              )}
                            </button>
                          );
                        })}
                  ...
                  {step === 4 && (
                    <StepGrid>
                      ...
                      <SelectField
                        ...
                        onChange={(v) => update("investmentStage", v)}
                  ...
                  {step === 5 && (
                    <div>
                      <div className="text-xs uppercase tracking-widest text-white/60">
                        Upload factory layouts, drawings, specifications, RFQ or technical files
                      </div>
                      <div
                        onDragOver={(e) => {
                          e.preventDefault();
                      ...
                      >
                        ...
                        <div className="mt-1 text-sm text-white/60">
                          PDF · CAD (DWG/DXF/STEP/IFC) · Images · ZIP — up to 50 MB per file
                        </div>
                        <div className="mt-6">
                          <button
                            type="button"
                          ...
                          {form.files.map((f) => (
                            ...
                            >
                              <span className="flex items-center gap-3 text-white/85">
                                <FileText className="h-4 w-4 text-emerald-400" /> {f.name}
                              </span>
      ...
      <Section id="contact-options" className="bg-background">
        <SectionHeader
          ...
          lede="Reach the engineering team directly on any channel."
        />
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-5">
          <div className="lg:col-span-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <ContactCard
              ...
              value="engineering@nevoindustrial.com"
              href="mailto:engineering@nevoindustrial.com"
            />
            <ContactCard
              icon={MessageCircle}
              label="WhatsApp"
            ...
            <ContactCard
              ...
              value="Book a 30-min engineering call"
              href="#wizard"
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border lg:col-span-2">
            <img
              ...
              decoding="async"
              src={dubaiImg}
              alt="NEVO Industrial — Dubai headquarters"
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 text-white">
              ...
              <div className="mt-2 text-lg font-semibold">
                Dubai · Saudi Arabia · Oman · Iraq · Turkey · Russia · Kenya · Cameroon
              </div>
            </div>
          </div>
        </div>
      ...
      <Section className="bg-muted/40">
        <SectionHeader
          ...
          lede="Four documents to structure your project before the first call."
        />
      ...
      <Section className="bg-background">
        <SectionHeader
          ...
          lede="Twenty-one of the most common questions from investors, contractors and engineers."
        />
      ...
      <section className="relative overflow-hidden bg-[#0B0D10] py-28 text-white md:py-36">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/70">
            Our engineering team is ready to review your project and provide the right industrial
            solution.
          </p>
          <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            >
              <a href="#contact-options">
                Book Engineering Consultation <ArrowUpRight className="ml-2 h-4 w-4" />
              </a>
            </Button>
          </div>
        </div>
  ...
  return (
    <label className="block">
      ...
      >
        ...
        {options.map((o) => (
          <option key={o} value={o} className="bg-[#0B0D10]">
            {o}
          </option>
        ))}
      </select>
...
function ContactCard({
  ...
  const inner = (
    <SurfaceCard
      className={`group flex items-start gap-4 p-6 transition hover:border-foreground/30 ${className}`}
    >
  ...
  return (
    <div className="rounded-3xl border border-emerald-500/40 bg-emerald-500/[0.06] p-10 text-center md:p-16">
      ...
      <p className="mx-auto mt-3 max-w-xl text-white/70">
        Our engineering team will review your intake and reply within 1–2 working days. You'll
        receive a technical proposal in 5–10 working days.
      </p>
      <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
        <a
          href="mailto:engineering@nevoindustrial.com"
          className="rounded-full border border-white/20 bg-white/5 px-6 py-3 text-sm hover:bg-white/10"
        >
        ...
        <a
          ...
          className="rounded-full bg-emerald-500 px-6 py-3 text-sm font-medium text-white hover:bg-emerald-400"
        >
