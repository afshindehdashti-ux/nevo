...
const PILLARS = [
  {
    ...
    body: "Market demand, product mix, target output, CAPEX model and launch roadmap before equipment selection.",
  },
  {
    icon: Building2,
    title: "Factory Master Planning",
    body: "Land use, hall geometry, material flow, utilities, expansion zones and installation access engineered as one system.",
  },
  {
    icon: Wrench,
    title: "Production Technology",
    body: "Continuous or discontinuous lines, roll forming, foaming, cutting, stacking, packaging and automation architecture.",
  },
  {
    icon: PackageSearch,
    title: "Raw Material Strategy",
    body: "PPGI, GI, Aluzinc, PIR/PUR chemistry, rock wool, adhesives and safety stock defined around the production plan.",
  },
  {
    icon: ShieldCheck,
    title: "Quality & Compliance",
    body: "EN, ASTM, GOST, SASO and local requirements translated into process controls, test plans and documentation.",
  },
  {
    icon: Gauge,
    title: "Ramp-Up & OEE",
    body: "Commissioning, operator training, recipe stabilization, waste reduction and performance reporting after first panels.",
  },
];
...
const FAQS: { q: string; a: string }[] = [
  {
    q: "What does turnkey factory development actually include?",
    a: "A single-contract scope covering feasibility, master planning, building and utility engineering, production line and roll forming, raw material strategy, automation, commissioning and operational ramp-up — one accountable engineering partner from empty plot to first invoiced panel.",
  },
  {
    q: "What CAPEX range should I expect for a greenfield sandwich panel factory?",
    a: "A typical continuous PIR/PUR factory ranges from roughly USD 6M to USD 25M depending on capacity, automation, cores (PIR/PUR/rock wool), building status and country. We size CAPEX against your target output and product mix during the feasibility phase, not from a catalogue.",
  },
  {
    q: "How long does it take to build a factory from decision to first panel?",
    a: "12 to 20 months is the realistic window from signed feasibility to commissioning, assuming land is available and financing is in place. Building works and long-lead equipment are the two critical paths we schedule around.",
  },
  {
    q: "Do I already need land, or can NEVO help select the site?",
    a: "Both. We can start with market and site selection studies — evaluating logistics, utilities, incentives and labour — or plug into your existing plot with a site survey and constraints analysis in the first weeks.",
  },
  {
    q: "Which markets have you developed factories in?",
    a: "Active projects and references across the GCC (UAE, Saudi Arabia, Oman, Qatar), Turkey, Iraq, East and Central Africa, CIS and select LATAM markets. Codes we regularly engineer to include EN, ASTM, GOST, SASO and IBC.",
  },
  {
    q: "Can we phase the investment and expand later?",
    a: "Yes. Master planning defines expansion zones, utility headroom, and building spans so a second line, wider panel, or additional core (e.g. adding rock wool later) can be inserted without shutting down the existing operation.",
  },
  {
    q: "Do you help arrange financing or bankable documentation?",
    a: "We prepare the technical and financial deliverables banks and investment authorities require — feasibility study, CAPEX/OPEX model, layouts, production plan, cash flow and payback — that plug into your local bank, ECA or development-fund process.",
  },
  {
    q: "Does NEVO buy the production line for us, or do we contract it directly?",
    a: "Either. We can act as EPC and take single-point responsibility for the line, or run an independent tender and technical evaluation while you sign directly with the OEM. The engineering rigour is the same.",
  },
  {
    q: "How do you protect our production capacity target during ramp-up?",
    a: "Commissioning includes recipe stabilisation, operator training, OEE tracking and a written ramp-up plan tied to weekly targets. Payment milestones are aligned to real production KPIs, not just mechanical completion.",
  },
  {
    q: "How is your factory development priced?",
    a: "Feasibility is a fixed engineering fee scoped to your project. Development is quoted per module — building/utility engineering, procurement, supervision, commissioning — or as a single turnkey price. You see the split before you sign.",
  },
];
  ...
  return (
    <section className="relative isolate -mt-20 overflow-hidden bg-black text-white md:-mt-24">
      <h1 className="sr-only">
        Factory Development for Sandwich Panel Manufacturing — NEVO Industrial
      </h1>
      <div className="relative min-h-[80vh] lg:min-h-[90vh]">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(0,0,0,1), rgba(0,0,0,0.58), rgba(0,0,0,0.16))",
            }}
          />
          <div
            aria-hidden
        ...
        <div className="container-wide relative flex min-h-[80vh] flex-col justify-between px-6 pt-36 pb-12 lg:min-h-[90vh] lg:px-8 lg:pt-44 lg:pb-16">
          ...
          >
            ...
            <p aria-hidden className="text-display text-balance text-white">
              Build a Sandwich Panel Factory{" "}
              <span className="text-accent">That Works From Day One.</span>
            </p>
            <p className="text-body-lg mt-8 max-w-2xl text-white/75">
              NEVO engineers the complete factory system — feasibility, layout, equipment,
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              >
                <a href="/ai-assistant">
                  Ask the AI Engineer <ArrowUpRight className="!size-4" />
                </a>
              </Button>
            </div>
          </motion.div>
  ...
  return (
    <Section tone="default">
      <SectionHeader
        ...
        title="Factory development is an engineered sequence — not a shopping list."
        lede="Every decision affects capacity, cash flow, quality, safety and future expansion. NEVO connects those decisions into one executable factory plan."
      />
      ...
      <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
        <div className="lg:col-span-5">
          ...
          <h2 className="text-h1 mt-6 text-balance text-primary-foreground">
            The production line is only one part of the factory.
          </h2>
          <p className="text-body-lg mt-6 text-primary-foreground/70">
            A profitable panel plant needs the correct building, raw material flow, utility
            envelope, quality system, automation layer and trained team around the line.
          </p>
        </div>
        <div className="lg:col-span-7">
          <div className="grid gap-px overflow-hidden rounded-xl bg-white/10 sm:grid-cols-2">
            {SYSTEMS.map((item) => (
              <div
                key={item}
                className="flex items-start gap-3 bg-primary p-5 text-sm text-primary-foreground/80"
              >
  ...
  return (
    <Section tone="surface">
      <SectionHeader
        ...
        title="From investment idea to installation-ready factory plan."
      />
      ...
      <div className="grid gap-12 lg:grid-cols-12">
        <div className="lg:col-span-4">
          <SectionHeader
            ...
            title="From site to running plant."
            lede="The eight phases NEVO owns when developing a new factory — site, building, utilities, contractors and handover."
          />
        </div>
    ...
    <Section tone="surface">
      <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
        <figure className="lg:col-span-6">
          <img
            src={investmentImg}
            alt="NEVO factory investment and ROI model"
        ...
        <div className="flex flex-col justify-center lg:col-span-6">
          ...
          <h2 className="text-h1 mt-6 text-balance text-foreground">
            CAPEX decisions tied to capacity, margin and growth.
          </h2>
          <p className="text-body-lg mt-6">
            NEVO models your factory around demand, line speed, panel thickness mix, labour, utility
            load, raw material consumption, expected yield and expansion strategy.
          </p>
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            {["CAPEX range", "Production capacity", "Raw material demand", "Payback scenarios"].map(
              (item) => (
                <div
                  key={item}
...
function ConnectedSolutions() {
  ...
  return (
    <Section tone="default">
      <SectionHeader
        eyebrow="Connected NEVO platform"
        title="Every factory workstream connects to a live NEVO route."
      />
      <div className="grid gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-2 lg:grid-cols-4">
        {links.map((l) => (
          <a
            key={l.title}
            href={l.href}
            className="group flex min-h-[180px] flex-col justify-between bg-background p-6 transition-colors hover:bg-surface"
          >
    ...
    <section className="bg-primary text-primary-foreground">
      <div className="container-wide section-y grid gap-10 lg:grid-cols-12 lg:items-end">
        <div className="lg:col-span-8">
          ...
          <h2 className="text-display mt-6 text-balance text-primary-foreground">
            Plan your factory before you buy the line.
          </h2>
          <p className="text-body-lg mt-6 max-w-2xl text-primary-foreground/70">
            Submit your land, target products, required output and budget range. NEVO will turn the
            starting point into an engineering conversation.
          </p>
        </div>
        <div className="flex flex-col gap-3 lg:col-span-4">
          ...
          >
            <a href="/ai-assistant">
              Estimate With AI <FileText className="!size-4" />
            </a>
          </Button>
        </div>
      </div>
