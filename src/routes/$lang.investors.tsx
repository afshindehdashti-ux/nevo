...
const SECTIONS = [
  {
    ...
    body: "Dubai-based industrial group operating across engineering, factory development, raw materials and sandwich panel manufacturing.",
  },
  {
    icon: Layers,
    title: "Corporate Structure",
    body: "NEVO Holding oversees four operating divisions with independent P&Ls and a shared engineering backbone.",
  },
  {
    icon: Target,
    title: "Strategic Vision",
    body: "To be the reference industrial engineering platform for emerging markets — building 100+ factories by 2035.",
  },
  {
    icon: TrendingUp,
    title: "Investment Opportunities",
    body: "Growth capital for regional expansion, greenfield lines and vertical raw material integration.",
  },
  {
    icon: Handshake,
    title: "Joint Ventures",
    body: "Structured JVs with local industrial partners for factory ownership, technology transfer and shared distribution.",
  },
  {
    icon: Globe2,
    title: "Partnership Programs",
    body: "Long-term supply, engineering and licensing agreements for OEMs, EPCs and sovereign industrial funds.",
  },
];
    ...
    <>
        ...
        <div className="container-wide relative py-32 md:py-40">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg text-white/70">
              NEVO Industrial combines engineering discipline with disciplined capital allocation —
              building factories, supply chains and long-duration cash flows across emerging
              markets.
            </p>
            <div className="mt-10 flex flex-wrap gap-3">
              <Button size="lg" asChild>
                <a href="#reports">
                  Download Investor Pack <ArrowRight className="ml-2 h-4 w-4" />
                </a>
              </Button>
              <Button
                size="lg"
            ...
            <div className="mt-16 grid max-w-3xl grid-cols-3 gap-8 border-t border-white/10 pt-8">
              <div>
                <div className="text-4xl font-semibold text-emerald-400">{cagr}%</div>
              ...
              <div>
                ...
                <div className="mt-1 text-xs uppercase tracking-widest text-white/50">
                  m² Annual Panel Output
                </div>
              </div>
              <div>
                <div className="text-4xl font-semibold text-emerald-400">{factories}</div>
                <div className="mt-1 text-xs uppercase tracking-widest text-white/50">
                  Factories Delivered
                </div>
              </div>
      ...
      <Section tone="surface">
        <SectionHeader
          ...
          title="FY 2024 at a glance"
          lede="Audited by Big-4. Full statements available in the 2024 Annual Report."
        />
        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
              Speak with our IR team
            </h2>
            <p className="mt-3 text-primary-foreground/70">
              Confidential briefings for institutional investors, sovereign funds and strategic
              partners.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 md:justify-end">
            <Button size="lg" variant="secondary" asChild>
              <a href="mailto:ir@nevo-industrial.com">ir@nevo-industrial.com</a>
            </Button>
            <Button
              size="lg"
              variant="outline"
