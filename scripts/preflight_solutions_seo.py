    ...
    if summary_path and any_artifact:
        ...
        with open(summary_path, "a", encoding="utf-8") as fh:
            ...
            fh.write(
                ...
                'document.querySelectorAll(".artifact-selection-count").forEach(el => { '
                ...
                'downloadBlobPayload("artifacts_selection.csv", "text/csv", header.join(",") + "\\r\\n" + body + "\\r\\n"); '
                '} '
                ...
                'if (e.key === "Escape") { closeArtifactDrawer(); } '
                '}); '
